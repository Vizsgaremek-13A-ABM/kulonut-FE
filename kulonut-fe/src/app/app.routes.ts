...
import { ConfirmLeaveGuard } from './guards/can_leave.guard';
...
export const routes: Routes = [
    ...
    { path: 'project/edit/:id', canActivate: [roleGuard], canDeactivate: [ConfirmLeaveGuard], loadComponent: () => import('./components/one-project-page/one-project-page').then(m => m.OneProjectPageComponent), data: { mode: 'edit', minRole: 50 } },
    { path: 'project/new', canActivate: [roleGuard], canDeactivate: [ConfirmLeaveGuard], loadComponent: () => import('./components/one-project-page/one-project-page').then(m => m.OneProjectPageComponent), data: { mode: 'new', minRole: 50 } },
